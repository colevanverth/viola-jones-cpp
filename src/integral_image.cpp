...
unsigned int IntegralImage::getSum(int m, int n, int mLength, int nLength) const {
...
unsigned int IntegralImage::getRows() const {
    return this->m_cols;
}

unsigned int IntegralImage::getCols() const {
    return this->m_rows;
}
